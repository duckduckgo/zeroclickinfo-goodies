...
my $dow = qr#Mon|Tue|Wed|Thu|Fri|Sat|Sun#;
my $short_month = qr#Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec#;
my $full_month = qr#January|February|March|April|May|June|July|August|September|October|November|December#;
my $time_24h = qr#(?:(?:[0-1][0-9])|(?:2[0-3])):[0-5][0-9]:[0-5][0-9]#;
my $time_12h = qr#(?:(?:0[1-9])|(?:1[012])):[0-5][0-9]:[0-5][0-9]\s?(?:am|pm)#;

# like: 1st 2nd 3rd 4-20,24-30th 21st 22nd 23rd 31st
my $number_suffixes = qr#(st|nd|rd|th)#;
...
sub date_regex {
    ...
    # ISO8601: 2014-11-27
    push @regexes, qr#[0-9]{4}-?[0-1][0-9]-?[0-3][0-9]([ T]$time_24h)?#;
    
    # HTTP: Sat, 09 Aug 2014 18:20:00
    push @regexes, qr#$dow, [0-9]{2} $short_month [0-9]{4} $time_24h?#;
    
    # RFC850 08-Feb-94 14:15:29 GMT
    push @regexes, qr#[0-9]{2}-$short_month-([0-9]{2}|[0-9]{4}) $time_24h?#;
    
    ## acceptable date formats
    # DMY: 27/11/2014 with a variety of delimiters and month formats
    push @regexes, qr#[0-3][0-9][\\/\._-][0-1][0-9][\\/\._-][0-9]{4}#;
    push @regexes, qr#[0-3][0-9][\\/\._-]$short_month[\\/\._-][0-9]{4}#;
    push @regexes, qr#[0-3][0-9][\\/\._-]$full_month[\\/\._-][0-9]{4}#;
    push @regexes, qr#[0-3]?[0-9] (?:$short_month|$full_month) [0-9]{4}#;
    
    ## fundamentally non-sensical date format, for americans
    # MDY: 11/27/2014
    push @regexes, qr#[0-1][0-9][\\/\,_-][0-3][0-9][\\/\,_-][0-9]{4}#;
    push @regexes, qr#$short_month[\\/\,_-][0-3][0-9][\\/\,_-][0-9]{4}#;
    push @regexes, qr#$full_month\\/\,_-][0-3][0-9][\\/\,_-][0-9]{4}#;
    push @regexes, qr#(?:$short_month|$full_month) [0-3]?[0-9] [0-9]{4}#;
