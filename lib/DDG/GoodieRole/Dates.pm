...
my $dow = qr#Mon|Tue|Wed|Thu|Fri|Sat|Sun#i;
...
sub date_regex {
    ...
    # ISO8601: 2014-11-27
    push @regexes, qr#[0-9]{4}-?[0-1][0-9]-?[0-3][0-9]([ T]$time_24h)?#i;
    
    # HTTP: Sat, 09 Aug 2014 18:20:00
    push @regexes, qr#$dow, [0-9]{2} $short_month [0-9]{4} $time_24h?#i;
    
    # RFC850 08-Feb-94 14:15:29 GMT
    push @regexes, qr#[0-9]{2}-$short_month-([0-9]{2}|[0-9]{4}) $time_24h?#i;
