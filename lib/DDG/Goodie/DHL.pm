...
handle query_nowhitespace_nodash => sub {
    ...
    if ($is_dhl) {
        return heading => "DHL Shipment Tracking", html => "Track this package at <a class='large' href='http://www.dhl-usa.com/content/us/en/express/tracking.shtml?brand=DHL&AWB=$package_number'>DHL</a>.";
    }
