...
my %data = (
    ...
    translation         => "Help translate DuckDuckGo: https://duck.co/translate",
    translations        => "Help translate DuckDuckGo: https://duck.co/translate",
    ...
    merchandise         => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    shirt               => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    shirts              => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    t-shirts            => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    sticker             => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    stickers            => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    stickers            => "Thanks for the support! You can find DuckDuckGo t-shirts, stickers, and other items here: https://duck.co/help/community/swag",
    quackandhack        => "QUACK!",
