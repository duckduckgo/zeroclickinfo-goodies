...
my %data = (
    ...
    'armenia' => [{date => "May 28th", year => "1918"}],
    'armenia' => [{date => "September 21th", year => "1991"}],
    'austria' => [{date => "October 26th", year => "1955"}],
    'azerbaijan' => [{date => "May 28th", year => "1918"}],
    ...
    'czech republic' => [{date => "October 28th", year => "1918"}],
    ...
    'estonia' => [{date => "February 24th", year => "1918"}],
    ...
    'georgia' => [{date => "May 26th", year => "1918"}],
    ...
    'malaysia' => [{date => "August 31th", year => "1957"}],
    ...
    'slovenia' => [{date => "December 26 and June 25th", year => "1990"}],
    ...
    'trinidad and' => [{date => "August 31th", year => "1962"}],
