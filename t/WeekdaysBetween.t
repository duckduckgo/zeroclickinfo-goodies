...
ddg_goodie_test(
    ...
    'week days between 01/06/2014 01/10/2014' =>
        test_zci("There are 5 weekdays between 06 $JAN_ABBREV 2014 and 10 $JAN_ABBREV 2014."),
    ...
    'weekdays between 01/13/2014 01/06/2014' =>
        test_zci("There are 6 weekdays between 06 $JAN_ABBREV 2014 and 13 $JAN_ABBREV 2014."),

    # Weekdays in a year - Dash format
    'weekdays between 01-01-2014 01-01-2015' =>
        test_zci("There are 262 weekdays between 01 $JAN_ABBREV 2014 and 01 $JAN_ABBREV 2015."),
    ...
    'weekdays between jan 3, 2014 jan 6, 2014' =>
        test_zci("There are 2 weekdays between 03 $JAN_ABBREV 2014 and 06 $JAN_ABBREV 2014."),

    # Same day
    'weekdays between jan 3, 2014 jan 3, 2014' =>
        test_zci("There is 1 weekday between 03 $JAN_ABBREV 2014 and 03 $JAN_ABBREV 2014."),
    
    # Same day on a weekend
    'weekdays between jan 4, 2014 jan 4, 2014' =>
        test_zci("There are 0 weekdays between 04 $JAN_ABBREV 2014 and 04 $JAN_ABBREV 2014."),
    
    # Starting on a Saturday
    'weekdays between 01/11/2014 01/14/2014' =>
        test_zci("There are 2 weekdays between 11 $JAN_ABBREV 2014 and 14 $JAN_ABBREV 2014."),

    # Starting on a Sunday
    'weekdays between 01/12/2014 01/17/2014' =>
        test_zci("There are 5 weekdays between 12 $JAN_ABBREV 2014 and 17 $JAN_ABBREV 2014."),
