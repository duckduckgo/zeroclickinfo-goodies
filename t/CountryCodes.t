...
ddg_goodie_test(
        ...
        "3 letter country code of China"         => test_zci(qq(ISO 3166: China - chn), html => qq($text China - chn)),
        "Japan 3 letter country code"            => test_zci(qq(ISO 3166: Japan - jpn), html => qq($text Japan - jpn)),
        "Russia two letter country code"         => test_zci(qq(ISO 3166: Russia - ru), html => qq($text Russia - ru)),
        ...
        "united states of america iso code"      => test_zci(qq(ISO 3166: United states of america - us), html => qq($text United states of america - us)),
        "3 letter iso code isle of man"          => test_zci(qq(ISO 3166: Isle of man - imn), html => qq($text Isle of man - imn)),
