...
S M T W T F S      November 2014
 ...
 30
",
        html => qq(<style type='text/css'>table.calendar { text-align: center; }

        .calendar th, .calendar td { width:2.5em; text-align:center; }

        .calendar__header { vertical-align: top; height: 2em; font-size: 1.25em; }
        .calendar__today { color:white; background-color: #808080; }
</style>
