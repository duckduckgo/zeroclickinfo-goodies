...
ddg_goodie_test(
    ...
    'passphrase'                        => test_zci(count_words(4)),
    'random passphrase'                 => test_zci(count_words(4)),
    'random pass phrase'                => test_zci(count_words(4)),
    'passphrase random'                 => test_zci(count_words(4)),
    'pass phrase random'                => test_zci(count_words(4)),
    'generate random passphrase'        => test_zci(count_words(4)),
    'create random passphrase'          => test_zci(count_words(4)),
    'create passphrase random'          => test_zci(count_words(4)),
