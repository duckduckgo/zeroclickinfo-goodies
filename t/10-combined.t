...
ddg_goodie_test(
    ...
    # CurrencyIn
    'currency in australia' => test_zci('The currency in Australia is the Australian dollar (AUD)', html => 'The currency in Australia is the Australian dollar (AUD)', answer_type => 'currency_in', is_cached => 1),
