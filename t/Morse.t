...
ddg_goodie_test(
    ...
    'morse hello, duck'             => build_test($duck, $duck, "hello, duck"),
    'morse SOS'                     => build_test($sos, $sos, "SOS"),
    'morse code SOS'                => build_test($sos, $sos, "SOS"),
    'morse code hello, duck'        => build_test($duck, $duck, "hello, duck"),
    'SOS morse'                     => undef,
