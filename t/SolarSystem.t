...
ddg_goodie_test(
    ...
    'mass of neptune' => test_zci("Neptune - Mass is 2.258 &times; 10<sup>26</sup> lbs",  html => qr{<div class="zci--objects"><span class="objects--objectImage"><img src=".*" height="40" width="40"/></span><span class="objects--info"><span class="text--primary objects--objectAttribute">2.258 &times; 10<sup>26</sup> lbs</span><span class="text--secondary objects--objectName">Neptune - Mass</span></span></div>}),
    ...
    DDG::Request->new(query_raw => "mass of neptune", location => test_location("au")) => test_zci("Neptune - Mass is 1.024 &times; 10<sup>26</sup> kg",  html => qr{<div class="zci--objects"><span class="objects--objectImage"><img src=".*" height="40" width="40"/></span><span class="objects--info"><span class="text--primary objects--objectAttribute">1.024 &times; 10<sup>26</sup> kg</span><span class="text--secondary objects--objectName">Neptune - Mass</span></span></div>}),
