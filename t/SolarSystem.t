...
ddg_goodie_test(
    ...
    DDG::Request->new(query_raw => "size earth", location => test_location("au")) => test_zci("Earth - Radius is 6,371.00 km",  html => qr{<div class="zci--objects"><span class="objects--objectImage"><img src=".*" height="40" width="40"/></span><span class="objects--info"><span class="text--primary objects--objectAttribute">6,371.00 km</span><span class="text--secondary objects--objectName">Earth - Radius</span></span></div>}),

    DDG::Request->new(query_raw => "what is the size of earth", location => test_location("au")) => test_zci("Earth - Radius is 6,371.00 km",  html => qr{<div class="zci--objects"><span class="objects--objectImage"><img src=".*" height="40" width="40"/></span><span class="objects--info"><span class="text--primary objects--objectAttribute">6,371.00 km</span><span class="text--secondary objects--objectName">Earth - Radius</span></span></div>}),
    ...
    DDG::Request->new(query_raw => "mass of neptune", location => test_location("au")) => test_zci("Neptune - Mass is 102,410,000,000,000,000,000,000,000 kg",  html => qr{<div class="zci--objects"><span class="objects--objectImage"><img src=".*" height="40" width="40"/></span><span class="objects--info"><span class="text--primary objects--objectAttribute">102,410,000,000,000,000,000,000,000 kg</span><span class="text--secondary objects--objectName">Neptune - Mass</span></span></div>}),
