...
ddg_goodie_test(
    ...
    '5 squared' => build_test('25', '5 ^ 2'),
    'sqrt(4)' => build_test('2', 'sqrt(4)'),
    '1.0 + 5 squared' => build_test('26', '1.0 + 5 ^ 2'),
    '3 squared + 4 squared' => build_test('25', '3 ^ 2 + 4 ^ 2'),
    '2,2 squared' => build_test('4,84', '2,2 ^ 2'),
    '0.8^2 + 0.6^2' => build_test('1', '0.8 ^ 2 + 0.6 ^ 2'),
    '2 squared ^ 3' => build_test('256', '2 ^ 2 ^ 3'),
    '2 squared ^ 3.06' => build_test('323.972172143725', '2 ^ 2 ^ 3.06'),
    '2^3 squared' => build_test('512', '2 ^ 3 ^ 2'),
    ...
    '4e5 +1 ' => build_test('400,001', '(4  *  10 ^ 5) + 1'),
    '3e-2* 9 ' => build_test('0.27', '(3  *  10 ^- 2) * 9'),
