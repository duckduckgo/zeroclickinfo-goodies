...
ddg_goodie_test(
    ...
    '418.1 / 2'           => build_test('4,181/20', '418.1 / 2'),
    '418.005 / 8'         => build_test('83,601/1,600', '418.005 / 8'),
    '0.8158 - 0.8157'     => build_test('1/10,000', '0.8158 - 0.8157'),
    ...
    '2 ** -9'           => build_test('1/512', '2 ^ -9'),
    '9 ** (1/2)'        => build_test('3', '9 ^ (1 / 2)'),
    '9 ** (-1/2)'       => build_test('1/3', '9 ^ (-1 / 2)'),
    '16 ** 0.25'        => build_test('2', '16 ^ 0.25'),
    '25 ** -0.5'        => build_test('1/5', '25 ^ -0.5'),
    ...
    '2,90 + 4,6'  => build_test('15/2', '2,90 + 4,6'),
    '100 - 96.54' => build_test('173/50', '100 - 96.54'),
    ...
    '2,2 squared'           => build_test('121/25', '2,2 squared'),
    ...
    '2divided by 4'         => build_test('1/2', '2 / 4'),
    ...
    '83.166.167.160/33'               => build_test('27.722.055.720/11', '83.166.167.160 / 33'),
