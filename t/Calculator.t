...
ddg_goodie_test(
    ...
    'pi - pi + e - e + 2.3' => build_test('23/10 = 2.3', 'pi - pi + e - e + 2.3'),
    # Misc
    ...
    'sin(1.0) + 1,05'      => undef,
    'sin(pi) + 1.37'       => build_test('137/100 = 1.37', 'sin(pi) + 1.37'),
    'cos(2pi)'             => build_test('1', 'cos(2 pi)'),
    'cos(0)'               => build_test('1', 'cos(0)'),
    'cos(pi/2)'            => build_test('0', 'cos(pi / 2)'),
    ...
    'tan(pi/4)'            => build_test('1', 'tan(pi / 4)'),
    'tan(pi/2)'            => undef,
