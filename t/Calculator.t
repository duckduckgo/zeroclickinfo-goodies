...
sub build_result {
    my %result = @_;
    return $result{text_result}, structured_answer => {
        id   => 'calculator',
        name => 'Calculator',
        data => {
...
sub build_test { test_zci(build_result(@_)) }
...
ddg_goodie_test(
    ...
    '4.7 / 10' => build_test(
        decimal         => '0.47',
        fraction        => '47/100',
        formatted_input => '4.7 / 10',
        text_result     => '47/100 = 0.47',
    ),
    '1 / 50',   => build_test(
        decimal         => '0.02',
        fraction        => '1/50',
        formatted_input => '1 / 50',
        text_result     => '0.02',
    ),
    ...
    # Logarithms
    'log(3)' => build_test(
        decimal         => '1.098612288668',
        formatted_input => 'ln(3)',
        text_result     => '≈ 1.098612288668',
    ),
    ...
    '3e-2* 9 ' => build_test(
        decimal         => '0.27',
        fraction        => '27/100',
        formatted_input => '3 × 10 ^ -2 × 9',
        text_result     => '27/100 = 0.27',
    ),
    ...
    # Inverse trig
    'arccos(1/2) in degrees' => build_test(
        decimal         => '60',
        formatted_input => 'arccos(1 / 2) in degrees',
        text_result     => '60°',
    ),
    ...
    '30!' => build_test(
        decimal         => '26,525,285,981,219,105,864 × 10 ^ 13',
        formatted_input => '30!',
        text_result     => '≈ 26,525,285,981,219,105,864 × 10 ^ 13',
    ),
    '28!' => build_test(
        decimal         => '304,888,344,611,713,860,501,504,000,000',
        formatted_input => '28!',
        text_result     => '304,888,344,611,713,860,501,504,000,000',
    ),
