...
ddg_goodie_test(
    ...
    '2pi'                   => build_test('≈ 6.28318530718', '2 π'),
    ...
    'sqrt(3 pi / 4 + 1) + 1' => build_test('≈ 2.831991945996', 'sqrt(3 π / 4 + 1) + 1'),
    # Alternate Symbols
    ...
    '3π + 7'                          => build_test('≈ 16.42477796077', '3 π + 7'),
