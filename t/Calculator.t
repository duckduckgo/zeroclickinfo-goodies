...
ddg_goodie_test(
    ...
    'sin(10000000000)'     => build_test('≈ -0.4875060250875', 'sin(10,000,000,000)'),
    'sin(-10000000000)'    => build_test('≈ 0.4875060250875', 'sin(-10,000,000,000)'),
    'cos(10000000000)'     => build_test('≈ 0.8731196226769', 'cos(10,000,000,000)'),
    'cos(-10000000000)'    => build_test('≈ 0.8731196226769', 'cos(-10,000,000,000)'),
    ...
    'factorial of 3' => build_test('6', 'factorial(3)'),
    ...
    '5!'           => build_test('120', '5!'),
    ## Combined
    'factorial of 3 factorial' => build_test('720', 'factorial(3)!'),
    ...
    '28!'          => build_test('≈ 304,888,344,611,714 × 10 ^ 15', '28!'),
