...
ddg_goodie_test(
    ...
    '12am my timezone in UTC' => build_test(q/4:00 AM UTC/, qq/12:00 AM $test_location_tz to UTC/),
    '12am local time in UTC' => build_test(q/4:00 AM UTC/, qq/12:00 AM $test_location_tz to UTC/),
    '12am in UTC' => build_test(q/4:00 AM UTC/, qq/12:00 AM $test_location_tz to UTC/)
);
restore_time();
...
ddg_goodie_test(
    ...
    '12am my timezone in UTC' => build_test(re(qr/5:00 AM UTC/), qq/12:00 AM $test_location_tz to UTC/),
    '12am local time in UTC' => build_test(re(qr/5:00 AM UTC/), qq/12:00 AM $test_location_tz to UTC/),
    '12am in UTC' => build_test(re(qr/5:00 AM UTC/), qq/12:00 AM $test_location_tz to UTC/),
);
