...
sub build_answer {
    my($title, $subtitle) = @_;
    return "Montly payment is " . $title . ". " . $subtitle,
        structured_answer => {
            data => {
                title => $title,
                subtitle => $subtitle
...
ddg_goodie_test (
    ...
    'loan 400000 4.5%' =>
        build_test('$2,026.74 for 30 years', 'Total interest paid is $329,626.85'),
    'loan $400000 4.5%' =>
        build_test('$2,026.74 for 30 years', 'Total interest paid is $329,626.85'),
    'loan $500000 4.5% with 20% down' =>
        build_test('$2,026.74 for 30 years', 'Total interest paid is $329,626.85'),
    'loan $500000 4.5% with $100000 down' =>
        build_test('$2,026.74 for 30 years', 'Total interest paid is $329,626.85'),
    'loan $250000 3% interest 15 years' =>
        build_test('$1,726.45 for 15 years', 'Total interest paid is $60,761.74'),
    ...
    'loan for 23000 with 5000 down and 12% interest' =>
        build_test('$185.15 for 30 years', 'Total interest paid is $48,654.10'),
    'loan 50000 usd at 1% 1 usd down' =>
        build_test('$160.82 for 30 years', 'Total interest paid is $7,894.96'),
    'loan 5 usd at 1% 1 usd down' =>
        build_test('$0.01 for 30 years', 'Total interest paid is $0.63'),
    '5 year loan with 3% interest on $23,000 1000 down' =>
        build_test('$395.31 for 5 years', 'Total interest paid is $1,718.67'),
    ...
    DDG::Request->new(query_raw => "loan 400000 MYR at 4.5%", location => test_location("my")) =>
        build_test('2,026.74 MYR for 30 years', 'Total interest paid is 329,626.85 MYR'),
   ...
   # Imagine a new country later appears, test defaulting to USD because we don't know about it
    ...
    'loan $500000 at 4.5% with 20% down 15 years' =>
        build_test('$3,059.97 for 15 years', 'Total interest paid is $150,795.17'),
    'borrow $500000 4.5%' =>
        build_test('$2,533.43 for 30 years', 'Total interest paid is $412,033.56'),
