...
ddg_goodie_test(
    ...
    'red html code' => test_zci(
        ...
        html => qq(<div class="zci--color-codes"><div class="colorcodesbox circle" style="background:#ff0000"></div><div class='column1 tx-clr--dk2'><p class='hex tx-clr--dk zci__caption'>Hex: #FF0000</p><p class='no_vspace'>RGBA(255, 0, 0, 1)</p><p class='no_vspace'>HSL(0, 100%, 50%)</p><p class='no_vspace'>CMYB(0%, 100%, 100%, 0%)</p><p><a href='http://labs.tineye.com/multicolr#colors=ff0000;weights=100;' class='tx-clr--dk2'>Images</a><span class='separator'> | </span><a href='http://www.color-hex.com/color/ff0000' title='Tints, information and similar colors on color-hex.com' class='tx-clr--dk2'>Info</a><span class='separator'> | </span><a href='/?q=color%20picker%20%23ff0000' class='tx-clr--dk2'>Picker</a></p></div><div class='column2 tx-clr--dk2'><div class='complementary'><div class='cols_column'><span class='mini-color circle' style='background: #00FFFF;'> </span></div><div class='desc_column'><p class='no_vspace'>Complementary #:</p><p class='no_vspace tx-clr--dk'><a onclick='document.x.q.value="#00FFFF";document.x.q.focus();' href='javascript:'>00FFFF</a></p></div></div><div><div class='cols_column'><span class='mini-color circle' style='background: #ff8000'> </span><span class='mini-color circle' style='background: #ff0080'> </span></div><div class='desc_column'><p class='no_vspace'>Analogous #:</p><p class='no_vspace tx-clr--dk'><a onclick='document.x.q.value="#FF8000";document.x.q.focus();' href='javascript:'>FF8000</a>, <a onclick='document.x.q.value="#FF0080";document.x.q.focus();' href='javascript:'>FF0080</a></p></div></div></div></div>)
    ),
