...
ddg_goodie_test(
    ...
    'convert 5 bytes to bit'          => test_zci('5 bytes is 40.000 bits'),
    '5 GB to megabyte'                => test_zci('5 gigabytes is 5000.000 megabytes'),
    ...
    '16 years in months'              => test_zci('16 years is 192.000 months'),
);
