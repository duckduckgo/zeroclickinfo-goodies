...
(function(DDH) {
    ...
    DDH.color_picker.build = function(ops){
        ...
        return {
            data: {
                saturation_value_path: DDG.get_asset_path('color_picker', 'saturation_value_gradient.png').replace('spice',  'goodie'),
                hue_path: DDG.get_asset_path('color_picker', 'hue_gradient.png').replace('spice', 'goodie')
            },
            onShow: function() {
