  ...
  "use strict";
    ...
    var Converter = {
        ...
        customUnits: [
            ...
            {name: 'petametre',        factor: '10 meters^15'},
            {name: 'exametre',         factor: '10 meters^18'},
            {name: 'zettametre',       factor: '10 meters^21'},
            {name: 'yottametre',       factor: '10 meters^24'},
            {name: 'parsec',           factor: '30.856776 kilometers^13'},
            ...
            {name: 'teraparsec',       factor: '10 parsec^12'},
