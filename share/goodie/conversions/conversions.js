  ...
  "use strict";
    ...
    var Converter = {
        ...
        customUnits: [
           ...
           // {name: 'metric_ton'  factor: '1 megagram'},
           // {name: 'long_ton',   factor: '1016.05 kilograms'},
           // {name: 'short_ton',  factor: '907.185 kilograms'},
           // {name: 'metric_quintal',  factor: '100 kilograms'},
           // {name: 'us_quintal',      factor: '100 kilograms'},
           // {name: 'french_quintal',  factor: '100 kilograms'},
           // {name: 'troy_ounce', factor: '31.1034768 grams'},
           // {name: 'slug',       factor: '14.593903 kilograms'},
           // {name: 'carat',      factor: '0.2 grams'},
           // {name: 'atomic_mass_unit', factor: '0.000000001660538921 femtograms'},
    ...
    var Units = {
        ...
        mass: {
            ...
            units: [
                ...
                { symbol: 'ton',            name: 'Ton' },
                { symbol: 'metric_ton',     name: 'Metric Ton'},
                { symbol: 'long_ton',       name: 'Long Ton'},
                { symbol: 'short_ton',      name: 'Short Ton'},
                ...
                { symbol: 'metric_quintal', name: 'Metric Quintal'},
                { symbol: 'us_quintal',     name: 'US Quintal'},
                { symbol: 'french_quintal', name: 'French Quintal'},
                { symbol: 'troy_ounce',     name: 'Troy Ounce'},
