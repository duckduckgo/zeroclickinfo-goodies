DDH.mathematics_cheatsheet = DDH.mathematics_cheatsheet || {};

(function(DDH) {
    "use strict";

    console.log('DDH.mathematics_cheatsheet.build'); // remove this before submitting pull request
    ...
    DDH.mathematics_cheatsheet.build = function(ops) {
        ...
        return {
            ...
            onShow: function() {
                ...
                //
                // var $dom = $(".zci--mathematics_cheatsheet");
